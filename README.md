...
- [Liquid Staking Platforms](#liquid-staking-platforms)
...
- [DeFi Prime](https://defiprime.com/defi-analytics) - At Defi Prime, we offer analytical and digital media services specifically tailored for the DeFi community.
...
- [Optimistic Etherscan](https://optimistic.etherscan.io/) - Optimistic Etherscan is a tool for exploring the Optimism blockchain.
...
- [Verichains](https://www.verichains.io/) - Welcome to Verichains, a renowned Web3 security company specializing in cryptography and fundamental blockchain technology.
...
- [VSCode Solidity Auditor](https://github.com/ConsenSys/vscode-solidity-auditor) - Enhance your Visual Studio Code experience with support for the Solidity language and added visual security auditing features.
...
- [Crypto.com](https://crypto.com/) - A crypto exchange based in Singapore that is centrally located.
...
- [Treehouse](https://www.treehouse.finance/) - Get a digital assets manager that shows you a clear picture of all your DeFi positions.
...
- [Tulip](https://tulip.garden/) - Tulip Protocol is a platform on Solana that helps you earn yield.
...
- [Dolomite](https://dolomite.io/) - A protocol for margin trading that operates on Arbitrum.
...
- [Spruce](https://spruceid.com/) - At SpruceID, we provide a variety of open-source tools for users to have control over their identity no matter where they are.
...
- [Cream Finance](https://app.cream.finance/) - C.R.E.A.M finance is a decentralized finance platform that lets users earn rewards by putting their tokens on hold, and borrow money quickly when they need it.
...
- [Polysynth](https://polysynth.com/) - Polysynth Protocol is a system that helps you manage DeFi Options Vaults. It uses Ethereum and Polygon technology.
...
- [Pagoda](https://www.pagoda.co/) - Pagoda helps you create startups on the internet using NEAR protocol infrastructure and tools.
...
- [Solana](https://solana.com/) - Solana is a Blockchain that is designed to be highly scalable and suitable for widespread use.
...
- [Yawww](https://www.yawww.io/) - Yawww is an NFT marketplace that is owned by the community and also serves as a platform for lending NFTs between individuals.
...
- [Syndica](https://syndica.io) - Syndica offers APIs for indexing, RPC infrastructure, ChainStream API, and additional features.

### React Tools
- [Next Web3 Boilerplate](https://github.com/mirshko/next-web3-boilerplate) - Introducing a Next.js Web3 template that uses Ethers.js, web3-react, Typechain, and React Hooks for easy data fetching.
- [Quiver](https://github.com/raid-guild/quiver) - Unlock the potential of Ethereum smart contracts by seamlessly connecting them with dapp frontends using React Hooks and Ethers.js.
- [Uniswap Web3 React](https://github.com/Uniswap/web3-react) - This library is simple to use and can be customized to suit your needs. It is designed for creating Ethereum dApps that work efficiently.

### Relayers
- [Biconomy Core](https://www.biconomy.io/) - Biconomy is a platform that helps with transactions and relaying infrastructure.
- [OpenZeppelin Relay](https://docs.openzeppelin.com/defender/relay) - Defender Relay is a tool that securely automates smart contract operations by sending transactions using an HTTP API.

### Rollup Frameworks
- [OP Stack](https://www.optimism.io/) - OP Stack is the building block software used in OP Mainnet and the Superchain.
- [ZK Stack](https://zksync.io/) - Introducing a ZK rollup framework that provides complete control over the data availability layer for gas tokens and sequencing.

### Rollups-as-a-Service (RaaS)
- [AltLayer](https://www.altlayer.io/) - Our protocol provides developers with a flexible and decentralized solution to launch appchains.
...
- [Radius](https://www.theradius.xyz/) - A reliable layer for sequencing information, designed to support future modular blockchains.

### Sidechains
- [Gnosis Chain](https://gnosis.io/) - Join the Ethereum sidechain, managed by a community of over 100,000 validators, offering lower gas fees than the Ethereum mainnet.
- [Polygon](https://polygon.technology/) - Polygon is a solution for Ethereum that helps make transactions faster and cheaper.
- [Skale](https://skale.space/) - Discover a versatile network with multiple chains that can enhance scalability for EVM projects.

### Smart Contract Templates
- [Boring Solidity](https://github.com/boringcrypto/BoringSolidity) - Discover a diverse assortment of versatile solidity contracts and libraries.
- [CantBeEvil License](https://github.com/a16z/a16z-contracts) - A reference point for smart contracts managed by A16z with the CantBeEvil License.
- [Cookbook](https://www.cookbook.dev/) - Find all the EVM smart contracts and open source projects using this search engine.
- [Gnosis V2](https://github.com/gnosis/gp-v2-contracts) - Explore a collection of Gnosis smart contracts available for developers to examine.
- [Hello World](https://github.com/alchemyplatform/hello-world-tutorial) - Introducing a basic Alchemy smart contract designed for beginners, specifically created to demonstrate the "Hello World" example.
- [OpenZeppelin](https://github.com/OpenZeppelin/openzeppelin-contracts) - OpenZeppelin Contracts is a freely available library used for developing smart contracts.
- [Polygon Smart Contract Tutorial](https://github.com/alchemyplatform/polygon-smart-contract-tutorial) - Get started quickly on creating Polygon smart contracts with Alchemy. This guide is perfect for Solidity beginners.
- [Polygon Smart Contracts](https://github.com/maticnetwork/contracts) - The smart contracts on the Matic Network define the rules of how the business works.
- [Popular Smart Contract Templates](https://github.com/marcelc63/popular-contract-templates) - Discover a collection of widely-used smart contract templates.
- [Serpentor](https://github.com/yearn/serpentor#readme) - Introducing Vyper, the open-source smart contracts for voting and governance on the blockchain.
- [Snekmate](https://github.com/pcaversaccio/snekmate#readme) - Discover a collection of versatile Vyper smart contracts, available completely for free and openly sourced.
- [Solady](https://github.com/Vectorized/solady) - A part of the Solmate project designed to make Solidity code more efficient in using gas.
- [Solbase](https://github.com/Sol-DAO/solbase#readme) - Discover a cutting-edge platform designed for efficient creation of smart contracts. Enjoy its modern features and optimized gas usage.
- [Solmate](https://github.com/transmissions11/solmate) - Get access to open source tools for developing Solidity smart contracts.
- [Synthetix Smart Contracts](https://github.com/Synthetixio/synthetix) - Introducing Synthetix liquidity protocol's smart contracts designed with solidity for various logic purposes and use cases.
- [Uniswap v3 Core](https://github.com/Uniswap/v3-core) - Welcome to the official repository for the smart contracts of the Core Uniswap v3 Protocol. Here, you can find all the necessary information related to these contracts.
- [Yearn Smart Contracts](https://github.com/yearn/yearn-vaults) - Discover the powerful smart contracts used in the Yearn Vault created with Solidity and Vyper.
- [Zolidity](https://github.com/z0r0z/zolidity) - Simple and hassle-free agreements that work on Ethereum. Let's test them out!

### Smart Contract Tools
- [Cairo Contracts Wizard](https://wizard.openzeppelin.com/cairo) - A user-friendly tool for developers working on Starknet Cairo, including a Graphical User Interface (GUI) and integration with Codesandbox.
- [Calldata Decoder](https://tools.deth.net/calldata-decoder) - dEth created a transaction calldata decoder that works in your browsers. It is a part of their dEth Tool suite.
- [Cast](https://github.com/foundry-rs/foundry/tree/master/cast) - The official tool from Foundry that allows you to interact with the EVM using command calls.
- [Chuff](https://github.com/alexroan/chuff#quickstart) - Discover powerful contract patterns for Solidity programming in OpenZeppelin, optimized in the efficient Huff assembly language.
- [Constructor Encoder](https://tools.deth.net/constructor-encoder) - Deth Tools created a collection of useful tools for developers working with Ethereum (EVM).
- [Drippie](https://github.com/ethereum-optimism/optimism/blob/develop/packages/contracts-periphery/contracts/universal/drippie/Drippie.sol) - An automated transaction system that operates at set time intervals.
- [Drizzle](https://github.com/trufflesuite/drizzle) - Discover a carefully selected collection of tools for developing DApps using JavaScript, Vue, and React.
- [ETH SDK](https://github.com/dethcrypto/eth-sdk) - The ETH SDK helps create small and safe SDKs for Ethereum smart contracts.
- [Ethereum Transaction Viewer](https://github.com/samczsun/ethereum-transaction-viewer-frontend) - Explore the frontend of the Ethereum transaction viewer with open source code available at https://tx.eth.samczsun.com/.
- [Ethereum VSCode Viewer](https://github.com/dethcrypto/dethcode) - Inspect Ethereum contracts that have been deployed using a VS Code browser.
- [Event Decoder](https://tools.deth.net/event-decoder) - A toolset for decoding events, encoding constructors, and calculating transactions.
- [Foundry Rust Template](https://github.com/gakonst/foundry-rust-template) - Foundry is a tool that helps in creating smart contracts for EVM using Rust programming language.
- [Foundry Template](https://github.com/paulrberg/foundry-template) - Develop Solidity smart contracts easily with a Foundry-stack template and testing tools.
- [Ganache](https://github.com/trufflesuite/ganache) - Experience a user-friendly simulator for Ethereum Virtual Machine that is perfect for developers and testers of smart contracts.
- [Hardhat Template](https://github.com/paulrberg/hardhat-template) - Start developing your Solidity smart contracts quickly with this easy-to-use hardhat-based quickstart.
- [Huff Starter Kit](https://github.com/smartcontractkit/huff-starter-kit) - Get free access to a collection of smart contract templates designed for use with Huff on Chainlink's hosted repository.
- [Huffmate](https://github.com/pentagonxyz/huffmate) - Discover a expanding collection of cutting-edge Huff language smart contracts that can be easily customized.
- [Metamorphic Contract Detector](https://github.com/a16z/metamorphic-contract-detector) - Find Ethereum smart contracts that can be changed or modified.
- [OpenZeppelin Test Helpers](https://github.com/OpenZeppelin/openzeppelin-test-helpers) - Test Helpers is a tool created by OpenZeppelin that helps with testing smart contracts.
- [OpenZeppelin Upgrades](https://docs.openzeppelin.com/upgrades-plugins/1.x/) - Get a collection of plugins for Hardhat and Truffle that make it easy to deploy and handle upgradeable contracts on the Ethereum blockchain.
- [PRBMath](https://github.com/paulrberg/prb-math) - This Solidity library can handle complex fixed-point math using both signed and unsigned variables.
- [Seth](https://dapp.tools/) - Experience the power of DappHub's Ethereum CLI to easily query contracts, send transactions, track logs, and manipulate data.
- [Sol2uml](https://github.com/naddison36/sol2uml) - A tool that helps you see and organize Solidity contracts.
- [Solidity Sandbox](https://github.com/maurelian/solidity-sandbox/) - This repo can be easily copied and used on Forge to test smart contracts using templates.
- [Sourcify](https://sourcify.dev/) - A software tool that checks the source code and metadata of EVM chains and connects them to a contract repository on IPFS.
- [Tenderly](https://tenderly.co/) - A platform for Ethereum developers to monitor, debug, and simulate smart contracts in real-time.
- [Transaction Decoder](https://tools.deth.net/tx-decoder) - Introducing a reliable Ethereum transaction decoder and conversion calculator created by DethTools for smooth operations.
- [TypeChain](https://github.com/dethcrypto/TypeChain) - This tool creates TypeScript bindings for smart contracts on the Ethereum blockchain.
- [Waffle](https://getwaffle.io/) - A smart contract testing library that is compatible with Typescript and designed to work smoothly with ethers.js on the Ethereum platform.
- [Wei Converter](https://www.alchemy.com/gwei-calculator) - This calculator can be used in your web browser or with software development kits (SDKs). It helps you easily convert between Wei, Gwei, and Ether units.
- [codeslaw](https://codeslaw.app) - codeslaw helps developers find smart contracts quickly, making Ethereum development faster.
- [dapp](https://github.com/dapphub/dapptools/blob/master/src/dapp/README.md) - Create Solidity decentralized applications easily using hevm CLI instead of relying on RPC for interacting with smart contracts.

### Smart Contract Wallets
- [Argent](https://www.argent.xyz/) - Argent is a type of wallet that can be used with Ethereum. It helps to simplify account management.
- [Candide](https://docs.candidewallet.com/) - Candide is a clever digital wallet that utilizes Account Abstraction technology.
- [Castle](https://castle.link/) - The wallet that will last forever.
- [Obvious](https://obvious.technology/) - Obvious is a wallet for your phone that lets you easily send and receive crypto.
- [Safe](https://safe.global/) - Safe is a special kind of wallet called a smart contract wallet, which only allows a transaction to go through if a certain number of people approve it.
- [Soul Wallet](https://soulwallet.io) - A secure wallet that uses smart contracts and is supported by the Ethereum community. #ERC4337
- [Stackup](https://www.stackup.sh/) - A free platform that helps you create web3 experiences by designing your own transaction processes and smart contract wallets.
- [UniPass](https://unipass.id) - UniPass is a wallet that doesn't hold your money for you and doesn't charge fees for transactions.
- [openfort](https://www.openfort.xyz/) - A wallet system for Web3 with a user experience similar to Web2.
- [pier wallet](https://www.pierwallet.com/) - Our pier provides a high-tech wallet for smart contracts (including account abstraction) on various blockchains.

### Social Tokens
- [Rally](https://rally.io/) - A website for artists and groups to create online economies using Social tokens and NFTs.
- [Roll](https://tryroll.com/) - Roll is a platform that provides the structure for social currency.
- [SoCool](https://socool.club/) - A wallet for creators in the crypto world.
- [Torum](https://intro.torum.com/) - Torum is a social media platform made specifically for people who use cryptocurrency.
- [iMe Lab](https://imem.app/) - iMe is a smart platform that uses Telegram and has a built-in Crypto Wallet for easy and secure messaging.

### Software Wallets
- [Alfa1](https://www.alfa1.io/) - Alfa1 is a digital asset management solution that was created in 2018. It can be easily customized and is user-friendly.
- [AlphaWallet](https://alphawallet.com/) - Alpha Wallet is a free and open-source web3 wallet designed for DeFi and NFTs, where you have complete control of your assets.
- [Apex](https://apexwallet.xyz/) - Introducing Apex Wallet, an innovative Ethereum wallet designed to securely store your digital assets.
- [Backpack](https://www.backpack.app/) - Introducing a wallet designed for xNFTs, where the X represents eXecutable. These are a unique type of NFTs that have the ability to evolve their state.
- [BlockWallet](https://blockwallet.io/) - A secure and user-friendly Web3 wallet that simplifies your experience across different chains.
- [Coin98](https://coin98.com/) - Get everything you need for decentralized finance in one convenient platform. Our app combines all the essential wallet features for a seamless experience.
- [Coinbase Wallet](https://www.coinbase.com/wallet) - Coinbase is a software wallet that works with EVM.
- [Dapp Pocket](https://www.dapppocket.io) - Experience a DeFi wallet that lets you access over 2,000 dapps. Easily store, send, and buy cryptocurrency.
- [Enkrypt](https://www.enkrypt.com/) - An open source wallet that does not require custody and is designed for use in a multichain future.
- [Frontier Wallet](https://frontier.xyz/) - Frontier is a wallet that helps you manage your Crypto, DeFi, and NFT investments. With Frontier, you can easily send, store, and invest in over 4000 different assets.
- [MEW wallet](https://www.mewwallet.com/) - The beautiful open source crypto wallet lets you buy, manage, swap, and control your cryptocurrencies.
- [MetaMask](https://metamask.io/) - MetaMask is a well-liked crypto wallet that works with EVM.
- [Multis](https://multis.co/) - A special wallet for cryptocurrency that needs multiple private keys to approve transactions.
- [Phantom Wallet](https://phantom.app/) - Phantom is a well-known crypto wallet that supports multiple digital currencies on three different blockchains: Solana, Ethereum, and Polygon.
- [Rainbow](https://rainbow.me/) - Rainbow is an easy-to-use wallet for Ethereum. It allows you to bridge and swap between different networks on Layer 2s.
- [Ronin Wallet](https://wallet.roninchain.com/) - The Ronin Wallet is a special wallet made for players of Axie Infinity.
- [Sequence](https://sequence.xyz/) - Build user-friendly decentralized applications effortlessly with our plug-and-play web3 tool suite.
- [Solflare](https://solflare.com/) - The Solana software wallet lets you easily send, receive, and store SPL tokens. Plus, it's super secure!
- [Taho Wallet (Formerly Tally Ho)](https://taho.xyz/) - Introducing the world's first and only web3 wallet that is open source and owned by the community.
- [TokenPocket](https://www.tokenpocket.pro/) - TokenPocket is a safe and versatile wallet for multiple digital cryptocurrencies.
- [TrustWallet](https://trustwallet.com/) - Trustwallet is a popular wallet that many people use to manage different cryptocurrencies within the Web3 ecosystem.
- [Zerion](https://zerion.io/) - A digital wallet for storing cryptocurrency that also allows users to manage their DeFi and NFT portfolios.
- [imToken](https://token.im/) - imToken is a wallet that supports different blockchains and has many features for decentralized finance (DeFi) and non-fungible tokens (NFTs).

### Solidity Developer Tools
- [Delegatable](https://github.com/delegatable/delegatable-sol) - This Solidity library allows you to create and sign messages outside of the blockchain. These messages grant specific powers to other individuals, but cannot be transferred to someone else.
- [ETHP2P](https://github.com/rjected/ethp2p#readme) - ETHP2P offers tools and formats to manage unprocessed Eth peer-to-peer messages.
- [Git Hooks](https://githooks.com/) - Git Hooks allow developers to customize and enhance how they push and pull code from GitHub.
- [Husky for Git Hooks](https://github.com/typicode/husky) - Improve your git commits with a Git Hooks manager that allows you to run scripts before or after each commit.
- [Prettier Solidity](https://github.com/prettier-solidity/prettier-plugin-solidity) - Make your Solidity code look better with this Prettier plugin. It automatically formats your code for you.
- [Pytest Cobra](https://pypi.org/project/pytest-cobra/) - Pytest Cobra is a testing tool made for smart contracts that work with Ethereum Virtual Machine (EVM) using Python.
- [Solidity Array Generator](https://github.com/mds1/solidity-generators#readme) - Solidity functions for generating evenly spaced arrays include linspace, arange, and logspace.
- [Solidity Compiler Selector](https://github.com/crytic/solc-select) - This plugin helps you easily manage and switch between different versions of the Solidity compiler.
- [Solidity Coverage](https://github.com/sc-forks/solidity-coverage) - Measure how much of your Solidity smart-contracts' code is being tested.
- [Solidity Documentation Generator](https://github.com/OpenZeppelin/solidity-docgen) - This tool can automatically create markdown documentation for Solidity projects.
- [Solidity Flattener](https://github.com/poanetwork/solidity-flattener) - This utility helps you merge a Solidity project into a single file.
- [Solidity Visual Auditor](https://marketplace.visualstudio.com/items?itemName=tintinweb.solidity-visual-auditor) - Boost the security of your Solidity code with this VS Code extension.
- [Surya](https://github.com/ConsenSys/surya) - A collection of tools for examining Solidity contracts.

### Sports NFT Dapps
- [Autograph](https://autograph.io/) - Autograph is a place where you can buy and sell unique digital items from famous athletes.
- [Bitci](https://www.bitci.com/en) - Bitci is a place where you can trade tokens representing different national football teams.
- [Chiliz](https://www.chiliz.com/en/) - Chiliz is a blockchain technology used by Socios.com, a popular marketplace for sports NFTs.
- [DraftKings Marketplace](https://marketplace.draftkings.com/) - DraftKings is a website where you can play fantasy sports and purchase your favorite NFTs.
- [Ethernity](https://ethernity.io) - Ethernity is a special place where you can find and buy NFTs (unique digital items) that are owned and verified by famous people.
- [Mercury.fan](https://www.mercury.fan/) - Mercury is a platform where you can buy and sell sports NFTs.
- [NBA TopShot](https://nbatopshot.com/) - NBA Topshot is a marketplace that focuses on basketball and uses NFTs.
- [NFL All Day](https://nflallday.com/) - NFL All Day is the authorized online platform for buying and selling digital collectibles related to the National Football League.
- [Socios](https://www.socios.com/) - Socios is a platform where people can come together to create fan communities.

### Static Analysis Tools
- [Amarna](https://github.com/crytic/amarna) - Amarna is a tool that can analyze and check the code in the Cairo programming language.
- [Ethlint](https://github.com/duaraghav8/Ethlint) - Ethlint, previously known as Solium, examines your Solidity code to identify any problems regarding style and security and then resolves them.
- [Rattle](https://github.com/crytic/rattle) - Rattle is a tool that analyzes smart contracts on the Ethereum Virtual Machine (EVM) even after they have been deployed.
- [Slither](https://github.com/crytic/slither) - Discover and analyze potential issues in smart contracts with our solidity static analysis framework and vulnerability detectors.
- [Solhint](https://protofire.github.io/solhint/) - Protofire has created a Solidity linter that is open-source and configurable. It helps identify and fix syntax-related vulnerabilities.
- [Solhint for IntelliJ](https://plugins.jetbrains.com/plugin/10177-solidity-solhint) - Solhint for IntelliJ is a handy plugin designed for the IntelliJ javascript IDE, which enhances your coding experience.
- [Solhint-Prettier Plugin](https://github.com/fvictorio/solhint-plugin-prettier) - Tidy up your files using the Solidity plugin for Prettier, a tool that formats code.

### Symbolic Execution Tools
- [Manticore](https://github.com/trailofbits/manticore/) - Manticore is a tool for analyzing Ethereum smart contracts and binaries by using symbolic execution.
- [Mythril](https://github.com/ConsenSys/mythril) - Mythril is a tool that can find security issues in EVM bytecode by analyzing it.
- [Oyente](https://oyente.tech/) - Oyente is a tool created in 2016 to check smart contracts for security issues.

### Testnets
- [Arbitrum Goerli](https://developer.arbitrum.io/public-chains) - Discover a reliable and primary testing environment (421613) for Arbitrum on the Nitro roll-up stack.
- [Goerli](https://goerli.net/) - Goerli is a testnet that allows developers to build Ethereum smart contracts using a proof-of-authority (PoA) consensus mechanism across different clients.
- [Mumbai](https://polygon.technology) - Get access to a Testnet for Polygon blockchain that includes a MATIC token faucet for deploying and running smart contract logic.
- [Optimism Goerli](https://community.optimism.io/) - Experience the full power of the official Optimism blockchain testnet, complete with all the remarkable features found on the mainnet.
- [Rinkeby](https://ethereum.org/en/developers/docs/networks/#rinkeby) - Experience seamless testing of Solidity smart contracts with our dedicated Ethereum testnet. Designed specifically for developers, our testnet provides a sandbox environment where you can easily assess and fine-tune your contracts. Plus, we offer faucet ETH, ensuring you have the necessary gas to fuel your testing endeavors.
- [Sepolia](https://ethereum.org/en/developers/docs/networks/#sepolia) - The Ethereum mainnet now has a new Proof-of-Stake testnet after merging.
- [Solana Devnet](https://docs.solana.com/clusters) - Developers can use the exclusive Solana cluster specifically designed for unreal faucet to receive airdropped SOL tokens for testing smart contracts.

### Token Gating Tools
- [Collab.Land](https://collab.land/) - Collab.Land is a bot that uses NFT tokens to control access to Telegram and Discord. It has more than 6.5 million verified wallets.
- [GateRepo](https://gaterepo.com/) - GateRepo is a platform that enables NFT developers to control access to their private GitHub repositories by using token-gating.
- [Grapes](https://grapes.network/) - Grapes provides social networking services on Solana, and also offers tools for DAOs.
- [Matrica](https://matrica.io/) - We offer services that use NFTs to verify, control access, and vote on Discord servers. We also provide an NFT wallet.
- [Novel](https://www.novel.com/) - Novel is an easy-to-use tool for merchants that allows them to create ecommerce stores with token access for customers.
- [Solaland](https://www.solalandhq.com/home) - Solaland gives NFT developers the power to manage who can enter their NFT communities built on Solana.
- [Submarine](https://submarine.me/) - Submarine is a simple way for creators to provide unlockable content without any coding required.

### Token Management Tools
- [Liquifi](https://www.liquifi.finance/) - Manage token distributions, compliance, and track vesting schedules quickly and easily.
- [Magna](https://www.magna.so/) - Easily handle tokens without any effort.
- [Token Unlocks](https://token.unlocks.app/) - Get access to a dashboard and stay up-to-date with the latest token information and insights on tokenomics.

### Token Price APIs
- [CoinAPI](https://www.coinapi.io/) - Get quick, trustworthy, and all-in-one data APIs for cryptocurrency markets.
- [CoinGecko API](https://www.coingecko.com/en/api) - The CoinGecko data market APIs are reliable and powerful APIs.
...
- [Hummingbot](https://hummingbot.org/) - A free local library that helps you create and run automated trading strategies, or bots.
- [Mimic](https://mimic.fi/) - Our platform automates DeFi processes and ensures secure transactions without relying on trust or centralized control. Manage your vault securely and retain full control of your assets.
- [Phalcon](https://phalcon.xyz) - Creating a strong security infrastructure for BlockChain technology.
- [TradingLite](https://www.tradinglite.com/) - TradingLite offers charts with real-time data to assist users in performing trading analysis.
- [TradingView](https://www.tradingview.com/crypto-screener/) - TradingView is a platform that allows traders and investors to view charts and data for technical analysis.

### Venture DAOs
- [BitDAO](https://www.bitdao.io/) - A treasury that is diverse and controlled by tokens, using its funds to support web3 builders through generations.
- [DAO.VC](https://dao.vc/) - We are a nonprofit organization that supports, helps to speed up, and links web3 startups without a central authority.
- [MetaCartel](https://www.metacartel.org/) - MetaCartel is a community-driven organization that helps and funds teams working towards the web3 vision.
- [OrangeDAO](https://www.orangedao.xyz/) - A venture fund for the Web3 era. We use DAO infrastructure to support and invest in early-stage crypto companies.
- [SeedClub](https://www.seedclub.xyz/) - SeedClub is a group that creates and supports communities.
- [Syndicate DAO](https://syndicate.io/) - Allows individuals to come together and invest money in web3 projects they support.

### Wallet Connection Tools
- [ConnectKit](https://docs.family.co/connectkit) - ConnectKit is a tool that helps connect wallets to DApps using React.
- [WalletConnect](https://walletconnect.com/) - WalletConnect is a system that links DApps (decentralized applications) with wallets, acting as a middle-ware infrastructure for Web3.
- [Web3 Modal](https://web3modal.com/) - Web3 Modal is an easy-to-use library for managing Web3 wallets.

### Wallet Developer Tools
- [Magic](https://magic.link/) - Magic is a versatile tool for developers that helps with onboarding and improving user experience.
- [Plaid Wallet Onboard](https://plaid.com/wallet-onboard/) - Easily link your app to more than 300 self-controlled wallets using Plaid Wallet Onboard.
- [RainbowKit](https://www.rainbowkit.com/) - RainbowKit is a library that uses React to help websites integrate digital asset wallets into their web3 interfaces.
- [Triangle](https://www.triangleplatform.com/) - Triangle is a strong foundation for creating multi-chain wallets through its API infrastructure.
- [Venly](https://www.venly.io/) - Venly is a company that provides services for Web3 technology. They offer services for wallets, tools for handling NFTs, and solutions for online marketplaces.

### Wallet SDKs
- [Web3Auth](https://web3auth.io/) - Web3Auth is a type of wallet service that you manage yourself, using advanced technology called multi-party computation.

### Wallet Security Tools
- [Blowfish](https://blowfish.xyz/) - Blowfish is a tool that helps evaluate the security of Web3 wallets.
- [Chaos Labs](https://chaoslabs.xyz/) - Chaos Labs offers services to help test and visualize DeFi platforms. We provide infrastructure for simulation, testing, data monitoring, and visualization.
- [Fire](https://www.joinfire.xyz) - See what will go in and out of your wallet, before you commit.
- [Kevlar](https://github.com/shresthagrawal/kevlar) - A nearby RPC proxy for Ethereum wallets that use proof of stake or post-merge.
- [Pocket Universe](https://pocketuniverse.app?utm_source=alchemy&utm_medium=website&utm_campaign=dappstore) - Get Pocket Universe, a free tool that protects your assets while signing web3 transactions using your browser.
- [Stelo Labs](https://stelolabs.com/) - Stelo is a tool that helps secure Web3 wallets.

### Web3 Achievements
- [FLOAT](https://floats.city/) - Organize events for your web3 communities and provide undeniable proof of their occurrence.
- [Mint Kudos](https://mintkudos.xyz/) - With Mint Kudos, anyone can create NFTs on Polygon that cannot be transferred, to document their contributions.
- [Noox](https://noox.world/) - With Noox, you can make your own personalized soulbound NFTs.
- [Sismo](https://www.sismo.io/) - Sismo is a flexible verification system that puts emphasis on being decentralized, ensuring privacy, and being user-friendly.
- [rep3](https://rep3.gg/) - rep3 utilizes web3 technology to offer credentialing services for various communities.

### Web3 Authentication Tools
- [Arcana Network](https://arcana.network/) - Arcana is a Web3 infrastructure that allows users to easily sign up with their social media or email accounts and create wallets where they have full control over their funds.
- [Dynamic](https://www.dynamic.xyz/) - Dynamic is a protocol that combines wallet authentication and user management into one convenient solution.
- [Lit](https://litprotocol.com/) - Lit Protocol is a network that helps manage keys in a decentralized way using threshold cryptography.
- [Picket API](https://picketapi.com/) - The Picket API is an API that helps authenticate Web3 wallets.
- [Privy](https://www.privy.io/) - Get all your users on board with web3 effortlessly using a user-friendly and reliable library.
- [SlashAuth](https://www.slashauth.com/) - SlashAuth is a tool that helps you log in to decentralized applications on the Web3 platform.

### Web3 Bridges
- [Across](https://across.to/) - Across is a bridge that brings positivity to the EVM-based chains.
- [Allbridge Core](https://home.core.allbridge.io/) - Easily exchange stablecoins across different blockchains.
- [Connext](https://www.connext.network/) - Connext is a bridge that can be put together for the blockchain.
- [Hop](https://app.hop.exchange/) - Hop Protocol allows tokens to be transferred between different layer 2 solutions on different blockchains.
- [LayerSwap](https://www.layerswap.io/) - LayerSwap connects centralized exchanges with layer-2 blockchains.
- [LayerZero](https://layerzero.network/) - LayerZero is a system that helps different parts of a blockchain network to communicate with each other.
- [Nomad](https://www.nomad.xyz/) - Nomad is a fast communication protocol that can connect different blockchains.
- [Router Protocol](https://www.routerprotocol.com/) - A big bridge that helps data flow between different levels and directions.
- [Stargate](https://stargate.finance/) - Stargate helps users easily move their funds between different DeFi platforms.
- [Swim Protocol](https://swim.io/) - Swim is a bridge connecting different chains on the Solana network.
- [Synapse Protocol](https://synapseprotocol.com/landing) - The Synapse Protocol allows different blockchains to talk to each other so that transactions can happen smoothly between them.
- [Wormhole](https://wormhole.com/) - Wormhole connects different blockchains in the xChain world.
- [Wrap Protocol](https://app.tzwrap.com/) - A special connection that lets you stake on farms using Ethereum and Tezos blockchains.
- [deBridge](https://debridge.finance/) - An advanced communication and compatibility system that allows the creation of applications that work on different blockchains.

### Web3 Creator Tools
- [Eno](https://www.eno.xyz/) - A protocol for publishing content that lets creators fully make money from their social media content.
- [Moonlana](https://www.moonlana.com/) - Moonlana is a special type of token found on the Solana Blockchain that is associated with internet culture.
- [SolanaTip](https://www.solanatip.io/) - Solanatip is a tool for Chrome that lets you easily send Solana tokens as tips to Twitter users.
- [Solstar](https://solstar.finance/) - SolStar is a system that lets communities make and send tokens.

### Web3 Credential Tools
- [DegenScore](https://degenscore.com/) - DegenScore provides a score that is based on how you use your wallet.
- [Gateway](https://www.mygateway.xyz/) - Gateway lets users create and manage verified credentials in a decentralized registry.
- [InCred](https://goincred.com/) - InCred is a platform that uses blockchain technology. It helps you acknowledge and give rewards to your employees or team members.
- [MetaGame](https://metagame.wtf/) - Come join our community focused on making the Metaverse inclusive, enjoyable, and profitable for all.
- [Metacrafters](https://try.metacrafters.io/) - Join our developer community and start learning Web3 skills while earning points through a fun gamified system.
- [Ormi Protocol](https://www.ormilabs.xyz/) - Ormi is a protocol that verifies reputation and credentials.

### Web3 Credit Scoring Tools
- [Masa](https://www.masa.finance/) - Our platform is a decentralized financial data platform where you can own and share your financial data.
- [Repute X](https://reputex.io/) - The ReputeX Score lets you know how reliable and trustworthy someone is based on their creditworthiness and on-chain actions.
- [RociFi](https://roci.fi/) - RociFi is a credit protocol that does not require a lot of collateral.
- [Spectral Finance](https://www.spectral.finance/) - Spectral Finance is a tool that helps evaluate credit and make on-chain capital usage more effective.

### Web3 Data Tools
- [Acentrik](https://acentrik.io/) - Find a platform where you can exchange private data in a secure way.
- [Airstack](https://www.airstack.xyz/) - Need a hassle-free way to access data from different projects and blockchain ecosystems? Look no further than our user-friendly API.
- [Bitquery](https://bitquery.io/) - We are a company that focuses on creating products for APIs. Our main goal is to solve problems related to blockchain data.
- [Bundlr](https://bundlr.network/) - Bundlr combines several layer 2 transactions into a single transaction on Arweave's layer 1.
- [Ceramic](https://ceramic.network/) - Ceramic is a network that spreads out information and allows web3 applications to combine data easily.
...
- [Space and Time](https://www.spaceandtime.io/) - Introducing a new kind of data warehouse that links on-chain and off-chain data to support smarter smart contracts.
- [Spring](https://springlabs.com/) - Spring Labs assists businesses in safely storing and exchanging sensitive information.
- [Token Flow](https://tokenflow.live/) - Token Flow is a special kind of technology that can gather information from any network, starting from the very beginning. It's like a time machine for the blockchain.
- [Token Terminal](https://tokenterminal.com/) - Token Terminal is a tool that collects and organizes financial information for blockchains and dApps.
- [Transpose](https://www.transpose.io/?utm_medium=partner&utm_source=alchemy-website&utm_campaign=dapp_store&utm_content=landing-page) - Get instant access to up-to-date blockchain data through a REST and SQL API.
- [Verida](https://www.verida.io/) - A decentralized identity-based platform for storing and sending data across different databases.
- [Whalemap](https://whalemap.io/) - Whalemap's analytics tools offer accurate and timely blockchain data that is useful for making informed decisions and taking action.
- [ZettaBlock](https://zettablock.com/) - Create your own fast APIs for your app using our real-time web3 data infrastructure designed for indexing and analytics.

### Web3 Education Resources
- [101](https://101.xyz/) - Earn real cryptocurrency while taking online courses at the best platform in the market.
- [Alchemy University](https://university.alchemy.com) - Discover the top-notch Solidity bootcamp that offers the perfect opportunity to master Ethereum development.
- [Bankless Academy](https://app.banklessacademy.com/) - Bankless Academy is a completely free and easily accessible educational platform that is open to everyone.
- [BitDegree](https://www.bitdegree.org/) - BitDegree is a platform where you can learn about blockchain technology.
- [ChainShot](https://www.chainshot.com/) - Join our Bootcamp, accessible from anywhere with an internet connection, to learn valuable skills in blockchain and smart contracts.
- [CryptoZombies](https://cryptozombies.io/) - CryptoZombies is a hands-on learning platform where you can easily understand the technical aspects of blockchains.
- [Developer DAO Academy](https://academy.developerdao.com/) - D_D Academy is a free educational platform made by the Developer DAO.
- [Flipside Crypto](https://flipsidecrypto.xyz/) - At Flipside, we assist users in accessing real-time Blockchain analytics whenever they need it.
- [HumanDAO Academy](https://academy.humandao.org/) - At HumanDAO, users can easily finish modules and tutorials to master NFTs.
- [Layer 3](https://beta.layer3.xyz/) - Layer3 is a place where you can easily learn about Web3.
- [LearnWeb3](https://learnweb3.io/) - Learnweb3 is a place where you can learn web3 development through a variety of courses. It also has a community for students to connect and share their knowledge.
- [Lirn](https://www.lirn.io/) - Welcome to our educational lab where we specialize in web3 technology. Our main focus is on creating a strong crypto economy within the education sector.
- [Metana - Web3 bootcamp](https://metana.io/) - Metana is a bootcamp that focuses on teaching Solidity and Rust, which are Web3 Blockchain programming languages.
- [Metaschool](https://metaschool.so/) - Metaschool is a place where developers come together to learn about web3.
- [NFT Evening](https://nftevening.com/) - NFTevening is the largest platform for NFT updates.
- [Pointer](https://www.pointer.gg/) - Pointer is a platform that rewards people for learning web3 development.
- [Rabbit Hole](https://rabbithole.gg/) - RabbitHole helps people discover and explore ways to make money with cryptocurrency.
- [Real Vision](https://www.realvision.com/crypto) - Real Vision is a top-notch video channel about cryptocurrencies.
- [Speedrun Ethereum](https://speedrunethereum.com/) - Looking to learn how to build on Ethereum? Speedrun Ethereum is here to help beginners get started.
- [StakeDAO academy](https://stakedao.org/) - StakeDAO Academy is a complete platform for learning about cryptocurrency and DeFi.
- [Starknet Ecosystem](https://starknet-ecosystem.com) - Discover a range of Starknet projects, job opportunities, performance data, and educational materials with the help of the Starknet Ecosystem.
- [Third Academy](https://www.third.academy/) - At Third Academy, you can take courses on Web3 and access a collection of educational articles.
- [buildspace](https://buildspace.so/) - Buildspace offers a collection of sample web3 projects and a supportive community for building together.

### Web3 Email Tools
- [Skiff](https://skiff.com/) - Skiff is a secure and decentralized tool for working together and exchanging messages.

### Web3 Game Studios
- [Dapper Labs](https://www.dapperlabs.com) - Dapper Labs is a company that makes games and collectible items called NFTs, using Web3 technology.
- [Gala Games](https://app.gala.games/) - Come and explore Gala Games, a gaming studio that uses Ethereum technology to create exciting NFT games where you can earn rewards while playing.
- [Nakamoto Games](https://www.nakamoto.games/) - Nakamoto Games is a game studio that creates games using Polygon. These games allow you to earn while you play and are built using Web3 technology.
- [UFO Gaming](https://ufogaming.io/) - UFO is an online gaming studio and metaverse with a space theme that is created on the Immutable X network.
- [Vulcan Forged](https://vulcanforged.com/) - Welcome to our crypto gaming studio! Here, you'll find everything you need to level up your gaming experience. We have an NFT marketplace, a DEX (decentralized exchange), and a wide range of games to explore.

### Web3 Games
- [Aavegotchi](https://www.aavegotchi.com/) - Aavegotchi is a game where you can collect NFTs that you can earn money from by playing. It combines RPG elements with DeFi features that make the game even more engaging.
- [Alien Worlds](https://alienworlds.io/) - Alien Worlds is a video game set in a science fiction fantasy world. Players use special items called NFTs within the game to complete missions.
- [Aurory](https://aurory.io/) - Aurory is an exciting Japanese role playing game on Solana that allows players to earn rewards by playing.
- [Axie Infinity](https://axieinfinity.com/) - Axie Infinity is a game where you can battle monsters, and it is based on Nintendo's Pokémon series. It uses blockchain technology.
- [Crabada](https://www.crabada.com/) - Crabada is a highly popular game on Avalanche where you can earn rewards by playing and it's all about exciting undersea adventures.
- [CryptoKitties](https://www.cryptokitties.co/) - CryptoKitties is a game on Ethereum where you can collect, trade, and breed cats that are non-fungible tokens (NFTs).
- [DeFi Kingdoms](https://defikingdoms.com/) - Defi Kingdoms is a big game on Harmony blockchain that tries to make decentralized finance more fun.
- [DeFi Land](https://defiland.app/) - DeFi Land is a game that helps you easily use DeFi apps and focuses on agriculture.
- [Decentraland](https://decentraland.org/) - Decentraland is a digital universe made on Ethereum where people can make and earn money from their creations.
- [Faraland](https://faraland.io/) - Faraland is a fantasy game on BSC where you strategically take turns and earn crypto rewards.
- [Funfair](https://funfair.io) - FunFair is a company using blockchain technology to make online gambling fair and transparent.
- [Illuvium](https://www.illuvium.io/) - Welcome to Illuvium, an exciting Web3 role-playing game where you can capture and battle unique NFT creatures to earn fantastic rewards.
- [Planet IX](https://planetix.com/) - Planet IX is the largest gaming and finance platform on the entire Polygon blockchain.
- [STEPN](https://stepn.com/) - STEPN is a unique game where you can earn rewards by walking or running while wearing NFT sneakers.
- [Sorare](https://sorare.com/) - Sorare lets you play a virtual game that brings the excitement of fantasy sports to life.
- [Splinterlands](https://splinterlands.com/) - Splinterland is a card game that can be played on the internet where people can gather, trade, and fight with their cards.
- [SweatCoin](https://sweatco.in/) - Earn tokens by simply walking and using this app.
- [The Sandbox](https://www.sandbox.game/en/) - In the Sandbox, a well-liked 3D metaverse game, you can make and earn money from NFTs (non-fungible tokens).
- [Zed Run](https://zed.run/) - Zed Run is a digital horse racing game on the Web3 platform. It rewards players for actively participating in the game through a play-to-earn token system.

### Web3 IDEs
- [Embark](https://framework.embarklabs.io/) - An editor for creating and launching Ethereum smart contracts and decentralized applications.
- [EthFiddle](https://ethfiddle.com/) - Create smart contracts easily with our Solidity development environment. Write, test, and deploy with simplicity.
- [IntelliJ IDEA](https://www.jetbrains.com/idea/) - IntelliJ IDEA is a code editor designed for the JavaScript Virtual Machine.
- [IntelliJ Solidity Plugin](https://github.com/intellij-solidity/intellij-solidity) - This Solidity plugin is well-liked for writing, testing, fixing issues, and launching smart contracts.
- [Remix](https://remix-project.org/) - Free software for creating and managing Ethereum applications.
- [Sublime Ethereum](https://github.com/davidhq/SublimeEthereum) - If you want to build with EVM-compatible languages, Sublime Ethereum is the code editor you need.
- [Tenderly Sandbox](https://sandbox.tenderly.co/) - Tenderly Sandbox is a code editor designed to help new developers feel more comfortable.
- [VScode](https://vscode.dev/) - A highly sought-after code editor for Web3 and Web2.
- [Yakindu](https://marketplace.eclipse.org/content/yakindu-solidity-tools) - Yakindu is a completely free program that helps you create programming code for Solidity contracts.

### Web3 Languages
- [Cairo](https://www.cairo-lang.org/) - A coding language for StarkNet that is compatible with ZK technology.
- [Go](https://go.dev/) - A widely used programming language for the backend of EVM smart contracts, providing logic and functionality.
- [Haskell](https://www.haskell.org/) - Haskell is a programming language specifically made for Cardano smart contracts, where you can give instructions in a clear and fixed way.
- [Huff](https://huff.sh/) - A coding language for creating efficient Ethereum Virtual Machine smart contracts.
- [Move](https://move-book.com/) - Discover a valuable learning tool for the Move programming language. It helps you create smart contracts on Aptos and Sui chains.
- [Rust](https://www.rust-lang.org/) - Solana employs a low-level programming language for creating versatile smart contracts.
- [Solidity](https://docs.soliditylang.org/en/latest/) - This programming language is very popular for writing smart contracts that are compatible with the EVM.
- [Vyper](https://vyper.readthedocs.io/en/latest/) - Easily write safe and straightforward smart contracts on the EVM using a Python-like programming language.
- [Yul](https://docs.soliditylang.org/en/latest/yul.html) - This is a programming language that can be compiled into bytecode for multiple backends.

### Web3 Libraries
- [Web3.py](https://web3py.readthedocs.io/en/v5/#) - Web3.py is a tool for working with Ethereum in Python.
- [ethers.js](https://docs.ethers.io/v5/) - An easy-to-use JavaScript library that allows you to effortlessly interact with the Ethereum blockchain.
- [libp2p](https://libp2p.io/) - Create peer-to-peer applications easily with a versatile set of networking tools.
- [light.js](https://github.com/paritytech/js-libs/tree/master/packages/light.js) - This JavaScript library is designed for light clients and focuses on reactivity.
- [web3.js](https://web3js.org/) - A library for TypeScript and JavaScript that helps DApps communicate with the Ethereum blockchain.
- [web3j](https://github.com/web3j/web3j) - This is a small and easy-to-use software for connecting Java and Android applications with Ethereum clients.

### Web3 Messaging Tools
- [Axelar](https://axelar.network/) - Axelar provides a safe way to communicate between different blockchain networks.
- [DEVp2p Wire Protocol](https://github.com/ethereum/devp2p/blob/master/rlpx.md) - Ethereum Org is a website that provides specifications for peer-to-peer communication.
- [Push Protocol](https://push.org/) - A messaging system and protocol for web3 decentralized apps that allows for notifications and direct communication among users.
- [XMTP](https://xmtp.com/) - XMTP is a messaging protocol that helps with decentralized communication for Web3.

### Web3 Payment Tools
- [Cask](https://www.cask.fi) - Cask is a system that handles money flows on the web without relying on a central authority.
- [Lightning Network](https://github.com/lightningnetwork/lnd) - This network is decentralized and uses smart agreements to make Bitcoin payments happen instantly.
- [Loop Crypto](https://www.loopcrypto.xyz/) - Our exclusive autopay feature doesn't require funds locking or any withdrawals. Enjoy true autopay without any hassles.
- [Paper](https://withpaper.com) - Buying NFTs and creating wallets is made simple with credit cards and email addresses on Paper.
- [Ponto](https://ponto.org/) - Get the necessary financial framework for managing digital assets.
- [Radom](https://www.radom.network/) - Easily make regular or one-time payments for online subscriptions and products without needing permission or intermediaries.
- [Sablier](https://sablier.finance/) - A protocol that allows DAOs and businesses to make web3 payments in seconds.
- [Superfluid](https://www.superfluid.finance/) - A streaming protocol for crypto payments that helps businesses manage subscriptions, salary payments, and rewards.
- [Tres Finance](https://www.tres.finance/) - Manage and keep track of your web3 assets smartly using Tres Finance's tools.

### Web3 Prediction Markets
- [Augur](https://www.augur.net/) - Augur is a prediction protocol that uses Ethereum and is not controlled by any central authority.
- [Hedgehog](https://hedgehog.app/) - Hedgehog is an app that helps you manage and trade digital currencies.
- [Polymarket](https://polymarket.com/) - Polymarket is a trading platform on the Polygon network that operates without a central authority.

### Web3 SDKs
- [Alchemy SDK](https://docs.alchemy.com/reference/alchemy-sdk-quickstart) - Discover the ultimate platform for creating web3 applications.
- [Dappkit](https://dappkit.dev/) - Dappkit is a platform that helps you make web3 applications.
- [Kurtosis](https://www.kurtosistech.com/) - Kurtosis is a top tool for creating and testing distributed systems.
...
- [Capture the Ether](https://capturetheether.com/) - Capture the Ether is an exciting game where you explore the world of Ethereum smart contracts through hacking, all while increasing your knowledge of security.
- [Damn Vulnerable DeFi](https://www.damnvulnerabledefi.xyz/index.html) - Damn Vulnerable DeFi is an educational game that teaches you about attacking DeFi smart contracts for offensive security purposes.
- [EVM Puzzles](https://github.com/fvictorio/evm-puzzles) - A variety of puzzles for EVM enthusiasts.
- [Ethernaut](https://ethernaut.openzeppelin.com/) - Ethernaut is an online game that uses Web3 and Solidity.
- [Paradigm CTF](https://ctf.paradigm.xyz/) - Join Paradigm CTF, an exciting online competition created for hackers specializing in smart contracts.

### Web3 Social Media Dapps
- [Arcade2Earn](https://www.arcade2earn.io/) - Arcade is a platform for playing games and earning tokens through metaverse games.
- [Bluesky](https://blueskyweb.org/) - Bluesky is working on making a web3-based internet by developing the AT Protocol.
- [Context](https://context.app/trending) - Context helps NFT traders easily see what influencers are doing with their wallets.
- [Continuum](https://continuum.xyz/) - Continuum is a social network where users can learn and earn crypto and NFTs for free.
- [CyberConnect](https://cyberconnect.me/) - CyberConnect is a social network that works without a central authority.
- [DSCVR](https://dscvr.one/) - A platform where users are in control of the content and the platform, making it a decentralized social content aggregation platform.
- [Entre](https://joinentre.com/) - Entre is an app for networking with professionals in the field of web3.
- [Ethereum World](https://ethereum.world/) - Bring decentralized apps together to create a user-friendly social experience.
- [Farcaster](https://www.farcaster.xyz/) - Farcaster is a decentralized social network that operates using an open protocol.
- [Fountain GmbH](https://fountainhub.com/en/) - Introducing a content ecosystem using Blockchain technology, built on the principle of Proof of Concept (PoC).
- [Interface](https://www.interface.social/) - Experience a user-friendly social web3 feed that is easily understandable by humans.
- [Islands](https://islands.xyz/) - A platform to manage web3 communities with a focus on NFTs.
- [Launchcaster](https://www.launchcaster.xyz/) - Discover the top projects on Farcaster with Launchcaster.
- [Lenster](https://lenster.xyz/) - Lenster is a social media app that uses Lens Protocol, allowing it to be decentralized and permissionless.
- [Lenstube](https://lenstube.xyz) - Lenstube is a social media platform for sharing videos that is powered by Lens Protocol, and it works in a decentralized way.
- [MINDS](https://www.minds.com/) - Minds is a free social network that supports Internet freedom.
- [Mask](https://mask.io/) - The Mask Network is a software developed and maintained by Dimension that is both free and open-source.
- [Meritverse](https://www.meritverse.xyz/) - Web3 is a network where professionals can connect.
- [Mirror](https://mirror.xyz/dashboard) - Mirror is a web publishing platform, like Medium, that uses blockchain encryption.
- [NF.td](https://nf.td/) - Create your unique username and manage your web3 identity.
- [Niche Club](https://www.niche.club/) - Niche is a fresh approach to social media that gives its members ownership of the network.
- [Orb](https://orb.ac/) - Orb is an app for making professional connections on the internet that works on the Polygon chain.
- [Orbis Club](https://orbis.club/) - Create social experiences that are decentralized using Orbis Protocol.
- [Paragraph](https://paragraph.xyz/) - Paragraph transforms your subscribers into valued members.
- [Phaver](https://phaver.com/) - A social app where you can earn rewards by sharing and actively participating, and even own a part of the platform.
- [RARA](https://rara.social) - RARA is a platform where anyone can curate NFTs with friends and be part of a social curation protocol.
- [RSS3](https://rss3.io/) - RSS3 is a way to share and find information on the Web3 using feeds and search.
- [Revel.xyz](https://www.revel.xyz/) - Revel is a platform where you can make and trade collectibles/NFTs of your own personal media while connecting with others.
- [Showtime](https://showtime.xyz) - Showtime is a social network for web3 that can be used on any device.
- [Status.IM](https://status.im/) - Status is a combination of a messaging app, wallet, and web browser that focuses on keeping your information secure.
- [Troop Finance](https://www.troop.finance/) - Troop Finance is a platform where people can work together on their finances.
- [Twetch](https://twetch.app/welcome) - Twetch is an online social network where you can earn money by contributing and participating, and it operates on the Solana blockchain.
- [gm](https://gm.xyz/) - gm.xyz is the perfect platform to start and expand your web3 community with ease.

### Web3 Testing Tools
- [ETH Lift](https://github.com/storming0x/ethlift-rs#readme) - A tool for using Foundry and Brownie projects in the command line.
- [Eth Tester](https://github.com/ethereum/eth-tester) - A collection of tools made with Python for testing Ethereum smart contracts.
- [Harbor](https://www.goharbor.xyz/) - Harbor creates efficient and ready-to-use staging environments and infrastructure for startups in the Web3 industry.
- [Solc Verify](https://github.com/SRI-CSL/solidity/blob/0.7/SOLC-VERIFY-README.md) - Introducing solc-verify – a compiler that automatically verifies Solidity code.
- [Synpress](https://github.com/Synthetixio/synpress) - Synpress is a testing framework that lets you test everything from start to finish easily. It has support for metamask, a tool that makes testing on the Ethereum blockchain simple.
- [anvil](https://github.com/foundry-rs/foundry/tree/master/anvil) - Anvil is a tool that lets you develop on Ethereum using Forge, similar to Ganache.

### Web3 VC Firms
- [Alchemy Ventures](https://www.alchemy.com/ventures) - We are an investment fund for Web3, focused on supporting teams that are creating groundbreaking blockchain products.
- [Chainforest DAO](https://www.chainforest.xyz/) - Chainforest is a VC firm that operates as a Decentralized Autonomous Organization (DAO) and receives support from its community.
- [Chapter One](https://chapterone.com/) - Chapter One is a complete crypto fund specifically designed for founders in the early stages.
- [Coinbase Ventures](https://www.coinbase.com/ventures) - Discover a venture capital fund that focuses on outstanding entrepreneurs and works towards expanding economic freedom.
- [Defiance Capital](https://defiance.capital/) - Defiance Capital is a top company in the world of cryptocurrency investments, specializing in Defi (decentralized finance) and gaming.
- [Dragonfly](https://www.dragonfly.xyz/) - Dragonfly is a worldwide company that invests in crypto projects.
- [FjLabs](https://fjlabs.com/web3/) - Fj Labs is a company that invests in technology companies that focus on the future.
- [Founders Fund](https://foundersfund.com/) - We invest in web3 companies that solve tough problems across the globe.
- [Founders Inc](https://f.inc/) - We are a venture capital firm that supports entrepreneurs in creating products in areas such as Web3 gaming, DeFi, and NFTs.
- [Jump Crypto](https://jumpcrypto.com/) - We are a company that invests in and builds infrastructure for different blockchains, including Solana.
- [Mechanism Capital](https://www.mechanism.capital/) - Mechanism Capital is a venture capital firm that primarily invests in games that use Blockchain technology and allow players to earn money while playing.
- [Multicoin Capital](https://multicoin.capital/) - We are an investment firm that focuses on cryptocurrencies, tokens, and businesses related to Blockchain technology.
- [Pantera Capital](https://panteracapital.com/) - Introducing the groundbreaking institution from the United States that specializes in managing assets related to Blockchain technology.
- [Paradigm](https://www.paradigm.xyz/) - We help and invest in upcoming web3 solutions, focused on cryptocurrencies.
- [Polychain Capital](https://polychain.capital/) - Get lucrative returns on your investments with our investment firm that specializes in managing portfolios of blockchain assets.
- [Polygon Ventures](https://polygon.technology/funds) - Polygon Ventures is an investment fund that focuses on helping the blockchain ecosystem grow and thrive.
- [Solana Ventures](https://solana.ventures/) - Solana Ventures is an investment fund that helps the Solana Ecosystem grow.
- [South Park Commons](https://www.southparkcommons.com/) - Join a supportive community of tech enthusiasts, developers, and learners who are committed to helping one another and discovering new things.
- [The Spartan Group](https://spartangroup.io/) - We are a venture capital firm that helps and supports the best entrepreneurs in the field of web3.
- [Tribe Capital](https://tribecap.co/crypto/) - We are a capital firm that specializes in creating unique companies using product and data science techniques.
- [a16z crypto](https://a16zcrypto.com/) - a16z is a company that invests in technology companies from their early stages to advanced stages.

### Webhooks
- [Alchemy Notify](https://docs.alchemy.com/reference/notify-api-quickstart) - Alchemy Notify is a service that sends notifications when something happens on a DApp using webhooks.
- [Wagmi](https://wagmi.sh/) - Wagmi is a set of React hooks that allow Ethereum applications to create and retrieve features from open-source functions.
